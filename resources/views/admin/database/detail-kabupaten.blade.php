            ...
            <section class="col-lg-4 connectedSortable" >
                <div class="box box-success" id="printArea1">
                    <div class="box-header with-border">
                        <h3 class="box-title">Detail Kabupaten {{ $kabupaten->nama }}</h3>
...
$(document).ready(function () {
    var url = "{{ url('database/detail-kabupaten-ajax') }}/" + "{{ $kabupaten->id }}" + "/" + $('#tahun').val()
    ajaxChart(url)

    $('#tahun').change(function () {
        var url = "{{ url('database/detail-kabupaten-ajax') }}/" + "{{ $kabupaten->id }}" + "/" + $(this).val()
        console.log(url)
        ajaxChart(url)
    })
            ...
            success: function(arrObject) {
                ...
                var myChart = new Chart(ctx, {
                    ...
                    options: {
                        ...
                        title: {
                        display: true,
                        text: 'Indeks Pemulihan Sektor Kelurahan {{ $kabupaten->nama}}'
                        },
                        responsive: true,
