                    ...
                    <div class="box-body">
                        <table class="table borderless">
                            <tr>
                                <td>Nama Petugas</td>
                                <td>:</td>
                                <td>{{ $keterangan_tempat->petugas_responden->petugas->nama }}</td>
                            </tr>
                            <tr>
                                <td>No Responden</td>
                                <td>:</td>
                                <td>{{ $keterangan_tempat->petugas_responden->no_responden }}</td>
                            </tr>
                            <tr>
                                <td>No KK</td>
                                <td>:</td>
                                <td>{{ $keterangan_tempat->petugas_responden->no_kk }}</td>
                            </tr>
                            <tr>
                                <td>Nama Responden</td>
                                <td>:</td>
                                <td>{{ $keterangan_tempat->petugas_responden->nama_responden }}</td>
                            </tr>
                            <tr>
                                <td>Kelurahan</td>
                                <td>:</td>
                                <td>{{ $keterangan_tempat->kel->nama }}</td>
                            </tr>
                            <tr>
                                <td>Tahun</td>
                                <td>:</td>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <thead>
                                    <th>Sektor</th>
                                    @foreach ($t_asc as $item)
                                        <th>{{ $item->tahun }}</th>
                                    @endforeach
                                </thead>
                                <tbody>
                                    @foreach ($ina_responden->groupBy('jenis_sektor_id') as $i)
                                    <tr>
                                        ...
                                        <td><b>
                                            ...
                                            @else
                                                @if ($j->ina_pdri >= 100)
                                                    <p class="text-success">{{ 'Pulih' }}</p>
                                                @else
                                                    <p class="text-danger">{{ "Belum Pulih" }}</p>
                                                @endif
                                            @endif
                                        </b></td>
                                        @php
...
$(document).ready(function () {
    var url = "{{ url('database/detail-responden-ajax') }}/" + "{{ $keterangan_tempat->id }}" + "/" + $('#tahun').val()
    ajaxChart(url)

    $('#tahun').change(function () {
        var url = "{{ url('database/detail-responden-ajax') }}/" + "{{ $keterangan_tempat->id }}" + "/" + $(this).val()
        console.log(url)
        ajaxChart(url)
    })
